...
function renderCountryList() {
  ...
  allCountries.forEach((country) => {
    ...
    const countryHTML = `
    <div class='country'>
    <div><a id="${id}" class="waves-effect waves-light btn">+</a>
      </div>
      <div><img src="${flag}" class="img" alt="${name}">
      </div>
      <div><ul><li>${name}</li>
      <li>${formattedPopulation}</li></ul>
      </div>
    </div>
    `;
...
function renderCountryFavorites() {
  ...
  favoriteCountries.forEach((country) => {
    ...
    <div class='country'>
    <div><a id="${id}" class="waves-effect waves-light btn red darken-4">-</a>
      </div>
      <div><img src="${flag}" class="img" alt="${name}">
      </div>
      <div><ul><li>${name}</li>
